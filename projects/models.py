...
class Project(models.Model):
    ...
    # Ime projekta
    project_name = models.CharField(_("name"), max_length=70)
    # Izvajalec
...
class ProjectAdress(models.Model):
    ...
    zip_code = models.CharField(_("poštna št."), max_length=30)
    # Država
    country = models.CharField(_("cdržava"), max_length=60)
...
class AdditionalProjectInfo(models.Model):
    ...
    resp_client_phone_num = models.CharField(_("Telefon"), max_length=50)
    resp_client_email = models.EmailField(_("Email"), max_length=254)
    resp_contractor_name = models.CharField(_("Odgovorna oseba s strani izvajalca"), max_length=50)
    resp_contractor_phone_num = models.CharField(_("Telefon"), max_length=50)
    resp_contractor_email = models.EmailField(_("Email"), max_length=254)
